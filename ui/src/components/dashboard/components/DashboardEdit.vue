<template>
    ...
    <section class="full-container">
        <dashboard-editor @save="save" v-if="dashboardSource" />
    </section>
</template>
...
<script>
    ...
    export default {
        ...
        methods: {
            async save(input) {
                await this.$store.dispatch("dashboard/update", input);
        ...
        beforeMount() {
            this.$store.dispatch("dashboard/load", this.id).then(dashboardSource => {
