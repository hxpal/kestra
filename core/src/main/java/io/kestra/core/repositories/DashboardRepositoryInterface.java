...
public interface DashboardRepositoryInterface {
    ...
    ArrayListTotal<Dashboard> list(Pageable pageable, String tenantId);

    default DashboardWithSource save(Dashboard dashboard, String source) {
        return this.save(null, dashboard, source);
    }

    DashboardWithSource save(@Nullable Dashboard previousDashboard, Dashboard dashboard, String source);
}
